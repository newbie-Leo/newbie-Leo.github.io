(function(config) {
    ...
    function oa() {
        ...
        return 0 <= a.indexOf("nvidia") || 0 <= a.indexOf("quadro") || 0 <= a.indexOf("geforce") || 0 <= a.indexOf("nvs") ? (b = ["nVidia"], 0 <= a.indexOf("geforce") && b.push("geForce"), 0 <= a.indexOf("quadro") && b.push("Quadro"), 0 <= a.indexOf("nvs") && b.push("NVS"), a.match(/\bion\b/) && b.push("ION"), a.match(/gtx\b/) ? b.push("GTX") : a.match(/gts\b/) ? b.push("GTS") : a.match(/gt\b/) ? b.push("GT") : a.match(/gs\b/) ? b.push("GS") : a.match(/ge\b/) ? b.push("GE") : a.match(/fx\b/) && b.push("FX"), (c = a.match(na)) && b.push(c[1].toUpperCase().replace("GS", "")), 0 <= a.indexOf("titan") ? b.push("TITAN") : 0 <= a.indexOf("ti") && b.push("Ti"), b = b.join(" ")) : 0 <= a.indexOf("amd") || 0 <= a.indexOf("ati") || 0 <= a.indexOf("radeon") || 0 <= a.indexOf("firegl") || 0 <= a.indexOf("firepro") ? (b = ["AMD"], 0 <= a.indexOf("mobil") && b.push("Mobility"), c = a.indexOf("radeon"), 0 <= c && b.push("Radeon"), 0 <= a.indexOf("firepro") ? b.push("FirePro") : 0 <= a.indexOf("firegl") && b.push("FireGL"), 0 <= a.indexOf("hd") && b.push("HD"), 0 <= c && (a = a.substring(c)), (c = a.match(na)) && b.push(c[1].toUpperCase().replace("HD", "")), b = b.join(" ")) : a.substring(0, 100)
    }
    ...
    sa = "devicePixelRatio" in fa && 1 < fa.devicePixelRatio || ra && "matchMedia" in fa && fa.matchMedia("(min-resolution:144dpi)") && fa.matchMedia("(min-resolution:144dpi)").matches,
    ta = ka("windows nt"),
    ua = -1 !== ba.search(/windows nt [1-5]\./),
    wa = -1 !== ba.search(/windows nt 5\.[12]/),
    xa = ua && !wa;
    ka("windows nt 10");
    var ya = ka("windows phone"),
    za = ka("macintosh"),
    Aa = ka("Mb2345Browser"),
    Ba = ka("ipad;") || ka("ipad "),
    Ca = Ba && sa,
    Da = ka("ipod touch;"),
    Ea = ka("iphone;") || ka("iphone "),
    Fa = Ea || Ba || Da,
    ...
    var Ia = Fa && ka("os 10_"),
    Ja = ka("android"),
    Ka = -1 !== ba.search(/android [123]/),
    La = ka("android 4");
    Ja && -1 === ba.search(/android [1-4]/) || ba.search(/android 4.4/);
    var Ma = Ja ? "android": Fa ? "ios": ta ? "windows": za ? "mac": "other",
    Na = ra && !fa.XMLHttpRequest,
    Qa = ra && !ga.querySelector,
    Ra = ra && !ga.addEventListener,
    Sa = ra && ka("ie 9"),
    Ta = ra && ka("msie 10"),
    Ua = ra && ka("rv:11"),
    Va = ka("edge"),
    ...
    lb = fa.navigator && fa.navigator.msPointerEnabled && !!fa.navigator.msMaxTouchPoints,
    mb = fa.navigator && fa.navigator.pointerEnabled && !!fa.navigator.maxTouchPoints,
    nb = mb || lb,
    ob = "ontouchstart" in ga || nb,
    pb = function() {
    ...
    qb = sa && (!kb || !!pb && 1 <= pb),
    rb = ra && "transition" in ha.style,
    sb = !!ga.createElementNS && !!ga.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
    tb = ga.createElement("canvas"),
    ub = !(!tb || !tb.getContext),
    vb = window.URL || window.webkitURL,
    wb = !ra && !(Xa && Ja) && window.Worker && vb && vb.createObjectURL && window.Blob,
    zb = "",
    pa = "",
    Ab = 0,
    Bb = {
    ...
    Fb = !ub || Wa || ya || kb && eb || Sa || Ga || Ca || Da || Ka || ka("gt-n710") || xa,
    Gb = !Fb && !Eb && (La || Ha || Fa && $a || !kb),
    Hb = Eb ? "vw": Fb ? "d": Gb ? "dv": "v",
    Ib = ka("webkit"),
    Jb = "WebKitCSSMatrix" in fa && "m11" in new window.WebKitCSSMatrix,
    Kb = "MozPerspective" in ha.style,
    Lb = "OTransition" in ha.style,
    Mb = rb || Jb || Kb || Lb,
    Nb = void 0 !== config[8] ? config[8] : !0,
    Ob = void 0 !== config[9] ? config[9] : !0,
    Pb = void 0 !== config[10] ? config[10] : !0,
    Qb = void 0 !== config[11] ? config[11] : !0,
    Rb = void 0 !== config[12] ? config[12] : null,
    Sb = !sb && kb && ub,
    Tb = !0;
    try {
    ...
    var bc = window.AMap.EG = {},
    cc = config[2].split(",")[0],
    dc = cc + "/css/v" + config[4] + "/style1504670922595.css",
    ...
    function sc(a) {
        ...
        c.charset = "utf-8";
        c.src = a; (a = b.body || qc) && a.appendChild(c)
    }
    function tc() {
    ...
    try {
        if (window.localStorage) {
            var vc = window.localStorage["_AMap_" + config.we],
            wc = !1;
...
})(["33079884b58711de84acdb5dcb80e004", [115.423411, 39.442758, 117.514625, 41.060816, 116.405285, 39.904989], "http://webapi.amap.com", 1, "1.4.0", null, "110000", "", true, true, true, true, "1508851419-1"])